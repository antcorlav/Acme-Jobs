...
<acme:list-column code="authenticated.company-record.list.label.ceo" path="ceo" width="20%"/>
...
<acme:list-column code="authenticated.company-record.list.label.phone" path="phone" width="20%"/>
<acme:list-column code="authenticated.company-record.list.label.email" path="email" width="20%"/>
<acme:list-column code="authenticated.company-record.list.label.indication" path="indication" width="20%"/>
