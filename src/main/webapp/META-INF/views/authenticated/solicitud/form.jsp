...
- purposes.  The copyright owner does not solicitud any warranties or representations, nor do
...
<acme:form readonly="true">
	<acme:form-money code="authenticated.solicitud.form.label.reward" path="reward" />
