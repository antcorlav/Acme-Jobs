...
@Service
public class CordonBulletinCreateService implements AbstractCreateService<Anonymous, CordonBulletin> {
	...
	public CordonBulletin instantiate(final Request<CordonBulletin> request) {
		...
		result.setCompany("Google");
		result.setDescription("No me gusta la empresa.");
		return result;
	}
